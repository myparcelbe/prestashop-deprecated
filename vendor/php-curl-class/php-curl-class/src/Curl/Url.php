...
use MPBpostModule\Curl\StringUtil;
class Url
{
    ...
    public static function removeDotSegments($input)
    {
        ...
        while (!empty($input)) {
            ...
            if (\MPBpostModule\Curl\StringUtil::startsWith($input, '../')) {
                $input = substr($input, 3);
            } elseif (\MPBpostModule\Curl\StringUtil::startsWith($input, './')) {
        ...
        if (isset($r['scheme'])) {
            ...
            if ($r['authorized']) {
                ...
                if (!isset($r['path']) || $r['path'] === '') {
                    ...
                    if (\MPBpostModule\Curl\StringUtil::startsWith($r['path'], '/')) {
